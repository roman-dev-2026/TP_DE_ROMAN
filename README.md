...
# <p style="text-align:center;"> DESARROLLO </p>
...
# 2.	¿Qué es el frontend y que es el backend? ¿De una definición con sus propias palabras y explique cómo se comunican habitualmente? #0941da
...
# 3.	¿Qué es una API REST? ¿Cuál es su función principal cuando desarrollamos una aplicación para dispositivos móviles? #0941da
...
# 4.	¿Qué es el formato JSON? Escribe un ejemplo simple de cómo se vería un objeto “alumno” con nombre, apellido y una lista de 3 notas en este formato. #0941da
...
# 6.	Control de Versiones y Conflictos. #0941da
...
# ¿Qué sucede si dos personas modifican la misma línea? #0941da
...
# 7.	Programación Orientada a Objetos (POO) #0941da
...
# 8.	Modificadores de Acceso: Public vs. Private #0941da
...
# 9.	Desarrollo: iOS vs. Android #0941da
...
# 10.	Tecnología y Discapacidad Visual. #0941da
